...
class ListaCortePages extends StatefulWidget {
  @override
  _RegistroRutasState createState() => _RegistroRutasState();
}

class _RegistroRutasState extends State<ListaCortePages> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Lista Cortes'), // AppBar personalizado
      body: Container(
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: TextStyle(color: const Color.fromARGB(255, 0, 0, 0)), // Texto blanco
                      ...
                      style: TextStyle(color: const Color.fromARGB(255, 0, 0, 0)), // Texto blanco
                    ),
                  ),
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      hint: Text(
                        "Seleccione una ruta",
                        style: TextStyle(color: const Color.fromARGB(255, 6, 6, 6)), // Texto blanco
                      ),
                      isExpanded: true,
